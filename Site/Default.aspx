        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Confirmar Venta</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="articuloCategoria" class="form-label">Método de pago</label>
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>

                    <div class="mb-3">
                        <label for="articuloStock" class="form-label">Pedidos Ya</label>
                        <asp:CheckBox ID="CheckBoxPedidosYa" runat="server" />
                        <%--<input type="ch" class="form-control" id="articuloStock" name="stock" required/>--%>
                    </div>
                </div>

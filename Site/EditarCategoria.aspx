<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarCategoria.aspx.cs" Inherits="Site.EditarCategoria" %>
...
<body>
     ...
     <form id="form1" runat="server" class="w-50">
        <div class="container mt-4">
            <h1><%: Request.QueryString["id"] != null ? "Editar Categoria" : "Agregar Categoria" %></h1>
            <div class="mb-3">
            ...
            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="btn btn-secondary" PostBackUrl="Categorias.aspx" />
